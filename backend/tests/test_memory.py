import pytest
import os
from database import init_db, get_farmer, save_farmer, save_call_summary, get_last_call_summary
...
def test_sqlite_crud():
    ...
    save_farmer(
        ...
        facts={"crops_grown": "cotton", "land_size_acres": 5.0, "district": "Yavatmal", "irrigation_type": "rainfed"}
    )
